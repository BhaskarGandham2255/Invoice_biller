    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body">
                        ...
                        <tbody>
                            <c:forEach var="category" items="${categories}" varStatus="loop">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/category/categoryUpdate?categoryId=${category.categoryId}" class="text-primary action-btn">
            ...
            <div class="text-center mt-4">
                <a href="${pageContext.request.contextPath}/menu/items" class="btn btn-outline-secondary">
                    ← Back to Items
                </a>
            </div>
